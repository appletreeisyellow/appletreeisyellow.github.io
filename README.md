...
6. Add Github API token to your local environment. [Here](https://mycyberuniverse.com/fixing-jekyll-github-metadata-warning.html) is the instruction.

If you don't do step 6, you should see something like:
